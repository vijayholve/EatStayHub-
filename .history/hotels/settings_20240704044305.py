...
DATABASES = {
       'default': dj_database_url.config(
        ...
        default='postgresql://user_databse_user:ItGsxeYeqbYUdQLoLh8GsMGcjUHAXU7o@dpg-cpujmqqj1k6c738bgv8g-a.oregon-postgres.render.com/user_databse'conn_max_age=600
    )
}
