...
def message_home(request,pk):
    ...
    sender=request.user
    sender_obj=message.objects.filter(sender=sender)
    receiver_obj=message.objects.filter(receiver=receiver)
    ...
    context={"receiver":receiver_obj,"sender_obj":sender_obj}
