...
def receiver_list(request,rest_id):
    ...
    user_lists={obj.id : obj.receiver.username for obj in message.objects.filter(Q(restaurant=restaurant ) &
                                       Q(receiver=restaurant.user)).distinct()}
    content={"receivers":receivers,"restaurant":restaurant,
             "users_lists":user_lists} 
